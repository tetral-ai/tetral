 ...
 * Validated durable lifecycle projection for one Thread turn. Cold loading and
 * committed Fact application produce this checkpoint; Reducer rules consume it
 * with separately owned read-only views. It contains no hot dispatch or Runtime
 * write identity.
 */
...
export const ProviderContextRetentionSchema = z.strictObject({
	disposition: z.enum([
		"completed",
		"interrupted",
		"rescheduled",
