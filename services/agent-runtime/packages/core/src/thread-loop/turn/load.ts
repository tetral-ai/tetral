 ...
 * Cold reconstruction boundary from durable Event, Message and Tool facts to a
 * validated ThreadTurnCheckpoint and Tool-route view. It performs no hot Fact
 * replay, dispatch or provider-history mutation.
 */
...
import {
	...
	ProviderContextRetentionSchema,
} from "./checkpoint.js";
...
export function extractNewestRequest(
