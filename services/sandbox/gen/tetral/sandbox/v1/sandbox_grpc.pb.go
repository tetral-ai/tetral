...
const (
	SandboxService_ReleaseSandbox_FullMethodName = "/tetral.sandbox.v1.SandboxService/ReleaseSandbox"
)
...
func (c *sandboxServiceClient) ReleaseSandbox(ctx context.Context, in *ReleaseSandboxRequest, opts ...grpc.CallOption) (*ReleaseSandboxResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReleaseSandboxResponse)
	err := c.cc.Invoke(ctx, SandboxService_ReleaseSandbox_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSandboxServiceServer) ReleaseSandbox(context.Context, *ReleaseSandboxRequest) (*ReleaseSandboxResponse, error) {
...
func _SandboxService_ReleaseSandbox_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReleaseSandboxRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SandboxServiceServer).ReleaseSandbox(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SandboxService_ReleaseSandbox_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SandboxServiceServer).ReleaseSandbox(ctx, req.(*ReleaseSandboxRequest))
	}
...
var SandboxService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tetral.sandbox.v1.SandboxService",
	HandlerType: (*SandboxServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ReleaseSandbox",
			Handler:    _SandboxService_ReleaseSandbox_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "tetral/sandbox/v1/sandbox.proto",
}
