...
bytes for `email` (defined by `gitidentity.MaxNameBytes` and
`gitidentity.MaxEmailBytes` in [the shared validator](../../internal/gitidentity/validation.go)).
It rejects controls, format characters, angle brackets,
