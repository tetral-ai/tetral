...
describe("provider-gateway schema verification", () => {
  test("accepts the exact current registry through SELECT-only SQL", async () => {
    ...
    const sql = schemaSQL(queries, [
      [{ exists: true }],
      [
        { version: 1, checksum: "de62988f2ba71da94c90f6c44fec606bc53579e875ab07af81ac1b37263878f0" },
      ],
    ]);
  ...
  for (const testCase of [
    ...
    { name: "duplicate", responses: [[{ exists: true }], [{ version: 1, checksum: "de62988f2ba71da94c90f6c44fec606bc53579e875ab07af81ac1b37263878f0" }, { version: 1, checksum: "de62988f2ba71da94c90f6c44fec606bc53579e875ab07af81ac1b37263878f0" }]], kind: "schema_history_duplicate" },
